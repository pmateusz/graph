...
struct r_c_shortest_paths_label : public boost::enable_shared_from_this<r_c_shortest_paths_label<Graph, Resource_Container> >
{
  ...
  {
    num = other.num;
    cumulated_resource_consumption = other.cumulated_resource_consumption;
    p_pred_label = other.p_pred_label;
  ...
  boost::shared_ptr<r_c_shortest_paths_label<Graph, Resource_Container> > p_pred_label;
  typename graph_traits<Graph>::edge_descriptor pred_edge;
